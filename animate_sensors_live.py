...
def animate(i,fig,ax):
    ...
    #     # stationary
    #     print('stationary')
    #     R_tilt = get_rotation_matrix_to_rotate_vector_a_to_vector_b(R_global.T[2],-acc)
...
# ani.save(f'anim.avi', writer=writervideo,progress_callback=lambda i, n: print(f'Saving frame {i} of {n}'))
plt.show()    
